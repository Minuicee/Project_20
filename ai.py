...
#TODO add training mode: every x words train the model
#TODO use AI to clear dataset
...
class ai(nn.Module): 
    ...
    def backprop(self, n_epochs, x_data, y_data, lr=1e-3):
        ...
        for epoch in range(n_epochs):
            ...
            print(f"Epoch {epoch + 1}/{n_epochs}, Loss: {total_loss/len(x_data):.5f}")
